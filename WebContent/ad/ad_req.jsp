...
<div id="adv">
	...
	<form id="advInsert" action="adInsert.do" method="post" enctype="multipart/form-data">
					<p>
						<label>타입</label> <input type="radio" name="tag"
							value="1" checked="checked">양쪽 <input type="radio"
							name="tag" value="2">세로 <input type="radio" name="tag"
							value="3">노출
					</p>
					<p>
						<label for="cy">회사명</label> <input type="text" name="cy" id="cy">
					</p>
					<p>
						<label for="nm">담당자명</label> <input type="text" name="nm" id="nm">
					</p>
					<p>
					...
					<p>
						<label>광고기간</label> <input type="text" id="from" name="dateS" readonly="readonly">
						~ <input type="text" id="to" name="dateE" readonly="readonly">
					</p>
					<p>
						<label>첨부파일</label> <input type="text" id="here" disabled="disabled" placeholder="최대용량 10MB"> 
...
기입하신 정보는 3개월 이후 자동파기 됩니다.
					...
					<p>
						<input type="button" id="cn" value="취소">
							<input type="button" id="in" value="보내기">
					</p>
				</form>
				</div>
		</section>
